...
('Bulbasaur', '001', 'Seed', 'Bulbasaur can be seen napping in bright sunlight.There is a seed on its back. By soaking up the suns rays,the seed grows progressively larger.', 0.7, 6.9, 2, 3, 2, 3, 3, 3),
('Ivysaur', '002', 'Seed', 'There is a bud on this Pokémons back. To support its weight,Ivysaurs legs and trunk grow thick and strong.If it starts spending more time lying in the sunlight,its a sign that the bud will bloom into a large flower soon.', 1.0, 13.0, 3, 3, 3, 4, 3, 3),
('Venusaur', '003', 'Seed', 'There is a large flower on Venusaurs back. The flower is saidto take on vivid colors if it gets plenty of nutrition and sunlight.The flowers aroma soothes the emotions of people.', 2.0, 100.0, 3, 4, 4, 5, 4, 4),
...
('Squirtle', '007', 'Tiny Turtle', 'Squirtles shell is not merely used for protection.The shells rounded shape and the grooves on its surfacehelp minimize resistance in water, enabling this Pokémonto swim at high speeds.', 0.5, 9.0, 2, 3, 3, 2, 3, 2),
('Wartortle', '008', 'Turtle', 'Its tail is large and covered with a rich, thick fur. The tailbecomes increasingly deeper in color as Wartortle ages.The scratches on its shell are evidence of this Pokémonstoughness as a battler.', 1.0, 22.5, 3, 3, 4, 3, 3, 3),
...
('Metapod', '011', 'Cocoon', 'The shell covering this Pokémons body is as hard as aniron slab. Metapod does not move very much. It stays stillbecause it is preparing its soft innards for evolution insidethe hard shell.', 0.7, 9.9, 2, 1, 3, 1, 1, 2),
...
('Raticate', '020', 'Mouse', 'Raticates sturdy fangs grow steadily. To keep them grounddown, it gnaws on rocks and logs. It may even chew on thewalls of houses.', 0.7, 18.5, 2, 4, 3, 2, 3, 5),
...
('Pikachu', '025', 'Mouse', 'Whenever Pikachu comes across something new,it blasts it with a jolt of electricity. If you come across ablackened berry, its evidence that this Pokémon mistook theintensity of its charge.', 0.4, 6.0, 2, 3, 2, 2, 2, 5),
('Raichu', '026', 'Mouse', 'If the electrical sacs become excessively charged,Raichu plants its tail in the ground and discharges.Scorched patches of ground will be found near thisPokémons nest.', 0.8, 30.0, 3, 5, 3, 4, 3, 6),
('Sandshrew', '027', 'Mouse', 'Sandshrews body is configured to absorb water without waste,enabling it to survive in an arid desert. This Pokémon curls upto protect itself from its enemies.', 0.6, 12.0, 2, 4, 4, 1, 1, 2),
('Sandslash', '028', 'Mouse', 'Sandslashs body is covered by tough spikes, which arehardened sections of its hide. Once a year, the old spikesfall out, to be replaced with new spikes that grow out frombeneath the old ones.', 1.0, 29.5, 3, 5, 5, 2, 2, 4),
...
('Nidoqueen', '031', 'Drill', 'Nidoqueens body is encased in extremely hard scales.It is adept at sending foes flying with harsh tackles.This Pokémon is at its strongest when it is defending its young.', 1.3, 60.0, 4, 5, 4, 4, 4, 4),
('Nidoran', '032', 'Poison Pin', 'Nidoran? has developed muscles for moving its ears. Thanksto them, the ears can be freely moved in any direction. Eventhe slightest sound does not escape this Pokémons notice.', 0.5, 9.0, 2, 3, 2, 2, 2, 3),
...
('Nidoking', '034', 'Drill', 'Nidokings thick tail packs enormously destructive power.With one swing, it can topple a metal transmission tower.Once this Pokémon goes on a rampage, there is no stopping it.', 1.4, 62.0, 3, 5, 3, 4, 3, 5),
...
('Ninetales', '038', 'Fox', 'Ninetales casts a sinister light from its bright red eyes to gaintotal control over its foes mind. This Pokémon is said to livefor a thousand years.', 1.1, 19.9, 3, 4, 3, 4, 4, 5),
('Jigglypuff', '039', 'Balloon', 'Jigglypuffs vocal cords can freely adjust the wavelength of itsvoice. This Pokémon uses this ability to sing at precisely theright wavelength to make its foes most drowsy.', 0.5, 5.5, 5, 2, 1, 2, 1, 1),
('Wigglytuff', '040', 'Balloon', 'Wigglytuff has large, saucerlike eyes. The surfaces of its eyesare always covered with a thin layer of tears. If any dust gets inthis Pokémons eyes, it is quickly washed away.', 1.0, 12.0, 5, 4, 2, 4, 2, 3),
...
('Vileplume', '045', 'Flower', 'Vileplumes toxic pollen triggers atrocious allergy attacks.Thats why it is advisable never to approach any attractiveflowers in a jungle, however pretty they may be.', 1.2, 18.6, 3, 4, 4, 5, 4, 3),
...
('Persian', '053', 'Classy Cat', 'Persian has six bold whiskers that give it a look of toughness.The whiskers sense air movements to determine what is in thePokémons surrounding vicinity. It becomes docile if grabbedby the whiskers.', 1.0, 32.0, 3, 4, 3, 3, 3, 6),
...
('Mankey', '056', 'Pig Monkey', 'When Mankey starts shaking and its nasal breathing turnsrough, its a sure sign that it is becoming angry. However,because it goes into a towering rage almost instantly,it is impossible for anyone to flee its wrath.', 0.5, 28.0, 2, 4, 2, 2, 2, 4),
...
('Growlithe', '058', 'Puppy', 'Growlithe has a superb sense of smell. Once it smells anything,this Pokémon wont forget the scent, no matter what. It usesits advanced olfactory sense to determine the emotions ofother living things.', 0.7, 19.0, 2, 4, 2, 3, 2, 3),
('Arcanine', '059', 'Legendary', 'Arcanine is known for its high speed. It is said to be capable ofrunning over 6,200 miles in a single day and night.The fire that blazes wildly within this Pokémons body is itssource of power.', 1.9, 155.0, 4, 6, 4, 5, 3, 5),
('Poliwag', '060', 'Tadpole', 'Poliwag has a very thin skin. It is possible to see thePokémons spiral innards right through the skin.Despite its thinness, however, the skin is also very flexible.Even sharp fangs bounce right off it.', 0.6, 12.4, 2, 3, 2, 2, 2, 5),
('Poliwhirl', '061', 'Tadpole', 'The surface of Poliwhirls body is always wet and slick witha slimy fluid. Because of this slippery covering, it can easilyslip and slide out of the clutches of any enemy in battle.', 1.0, 20.0, 3, 3, 3, 2, 2, 5),
('Poliwrath', '062', 'Tadpole', 'Poliwraths highly developed, brawny muscles never growfatigued, however much it exercises. It is so tirelessly strong,this Pokémon can swim back and forth across the oceanwithout effort.', 1.3, 54.0, 4, 5, 4, 3, 4, 4),
...
('Alakazam', '065', 'Psi', 'Alakazams brain continually grows, making its head far tooheavy to support with its neck. This Pokémon holds its head upusing its psychokinetic power instead.', 1.5, 48.0, 2, 3, 2, 7, 4, 6),
('Machop', '066', 'Superpower', 'Machops muscles are special—they never get sore no matterhow much they are used in exercise. This Pokémon hassufficient power to hurl a hundred adult humans.', 0.8, 19.5, 3, 4, 2, 2, 2, 2),
('Machoke', '067', 'Superpower', 'Machokes thoroughly toned muscles possess the hardnessof steel. This Pokémon has so much strength, it can easilyhold aloft a sumo wrestler on just one finger.', 1.5, 70.5, 3, 5, 3, 2, 3, 3),
...
('Bellsprout', '069', 'Flower', 'Bellsprouts thin and flexible body lets it bend and sway toavoid any attack, however strong it may be. From its mouth,this Pokémon spits a corrosive fluid that melts even iron.', 0.7, 4.0, 2, 4, 2, 3, 1, 2),
...
('Tentacool', '072', 'Jellyfish', 'Tentacools body is largely composed of water. If it is removedfrom the sea, it dries up like parchment. If this Pokémonhappens to become dehydrated, put it back into the sea.', 0.9, 45.5, 2, 2, 2, 2, 4, 4),
('Tentacruel', '073', 'Jellyfish', 'Tentacruel has large red orbs on its head. The orbs glowbefore lashing the vicinity with a harsh ultrasonic blast.This Pokémons outburst creates rough waves around it.', 1.6, 55.0, 3, 4, 3, 4, 5, 5),
('Geodude', '074', 'Rock', 'The longer a Geodude lives, the more its edges are chippedand worn away, making it more rounded in appearance.However, this Pokémons heart will remain hard, craggy,and rough always.', 0.4, 20.0, 2, 4, 4, 1, 1, 1),
...
('Slowpoke', '079', 'Dopey', 'Slowpoke uses its tail to catch prey by dipping it in water atthe side of a river. However, this Pokémon often forgets whatits doing and often spends entire days just loafing atwaters edge.', 1.2, 36.0, 4, 3, 3, 2, 2, 1),
('Slowbro', '080', 'Hermit Crab', 'Slowbros tail has a Shellder firmly attached with a bite.As a result, the tail cant be used for fishing anymore.This causes Slowbro to grudgingly swim and catchprey instead.', 1.6, 78.5, 4, 4, 5, 5, 3, 2),
...
('Farfetchd', '083', 'Wild Duck', 'Farfetchd is always seen with a stalk from a plant of somesort. Apparently, there are good stalks and bad stalks. ThisPokémon has been known to fight with others over stalks.', 0.8, 15.0, 2, 3, 3, 3, 3, 3),
('Doduo', '084', 'Twin Bird', 'Doduos two heads never sleep at the same time. Its twoheads take turns sleeping, so one head can always keepwatch for enemies while the other one sleeps.', 1.4, 39.2, 2, 4, 2, 2, 2, 4),
('Dodrio', '085', 'Triple Bird', 'Watch out if Dodrios three heads are looking in three separatedirections. Its a sure sign that it is on its guard. Dont go nearthis Pokémon if its being wary—it may decide to peck you.', 1.8, 85.2, 3, 6, 3, 3, 3, 5),
...
('Grimer', '088', 'Sludge', 'Grimers sludgy and rubbery body can be forced through anyopening, however small it may be. This Pokémon enters sewerpipes to drink filthy wastewater.', 0.9, 30.0, 3, 4, 2, 2, 2, 2),
('Muk', '089', 'Sludge', 'From Muks body seeps a foul fluid that gives off anose-bendingly horrible stench. Just one drop of thisPokémons body fluid can turn a pool stagnant and rancid.', 1.2, 30.0, 4, 5, 3, 3, 4, 3),
...
('Drowzee', '096', 'Hypnosis', 'If your nose becomes itchy while you are sleeping, its a suresign that one of these Pokémon is standing above your pillowand trying to eat your dream through your nostrils.', 1.0, 32.4, 3, 3, 2, 2, 4, 2),
...
('Marowak', '105', 'Bone Keeper', 'Marowak is the evolved form of a Cubone that has overcomeits sadness at the loss of its mother and grown tough.This Pokémons tempered and hardened spirit is noteasily broken.', 1.0, 45.0, 3, 4, 5, 2, 3, 3),
('Hitmonlee', '106', 'Kicking', 'Hitmonlees legs freely contract and stretch. Using thesespringlike legs, it bowls over foes with devastating kicks.After battle, it rubs down its legs and loosens the muscles toovercome fatigue.', 1.5, 49.8, 2, 6, 2, 2, 5, 5),
...
('Rhydon', '112', 'Drill', 'Rhydons horn can crush even uncut diamonds. One sweepingblow of its tail can topple a building. This Pokémons hide isextremely tough. Even direct cannon hits dont leave a scratch.', 1.9, 120.0, 4, 7, 5, 2, 2, 2),
...
('Tangela', '114', 'Vine', 'Tangelas vines snap off easily if they are grabbed.This happens without pain, allowing it to make a quickgetaway. The lost vines are replaced by newly grown vines thevery next day.', 1.0, 35.0, 3, 3, 5, 5, 2, 3),
('Kangaskhan', '115', 'Parent', 'If you come across a young Kangaskhan playing by itself, youmust never disturb it or attempt to catch it. The babyPokémons parent is sure to be in the area, and it will becomeviolently enraged at you.', 2.2, 80.0, 4, 5, 4, 2, 3, 5),
...
('Seadra', '117', 'Dragon', 'Seadra sleeps after wriggling itself between the branches ofcoral. Those trying to harvest coral are occasionally stung bythis Pokémons poison barbs if they fail to notice it.', 1.2, 25.0, 2, 3, 4, 5, 2, 5),
('Goldeen', '118', 'Goldfish', 'Goldeen is a very beautiful Pokémon with fins that billowelegantly in water. However, dont let your guard down aroundthis Pokémon—it could ram you powerfully with its horn.', 0.6, 15.0, 2, 4, 3, 2, 2, 3),
('Seaking', '119', 'Goldfish', 'In the autumn, Seaking males can be seen performingcourtship dances in riverbeds to woo females. During thisseason, this Pokémons body coloration is at its most beautiful.', 1.3, 39.0, 3, 5, 3, 3, 3, 4),
('Staryu', '120', 'Star Shape', 'Staryus center section has an organ called the core thatshines bright red. If you go to a beach toward the end ofsummer, the glowing cores of these Pokémon look like thestars in the sky.', 0.8, 34.5, 2, 2, 3, 3, 2, 5),
('Starmie', '121', 'Mysterious', 'Starmies center section—the core—glows brightly in sevencolors. Because of its luminous nature, this Pokémon hasbeen given the nickname “the gem of the sea.&quot;', 1.1, 80.0, 3, 4, 4, 5, 4, 6),
...
('Scyther', '123', 'Mantis', 'Scyther is blindingly fast. Its blazing speed enhances theeffectiveness of the twin scythes on its forearms.This Pokémons scythes are so effective, they can slicethrough thick logs in one wicked stroke.', 1.5, 56.0, 3, 6, 4, 3, 3, 6),
...
('Magmar', '126', 'Spitfire', 'In battle, Magmar blows out intensely hot flames from allover its body to intimidate its opponent. This Pokémonsfiery bursts create heat waves that ignite grass and treesin its surroundings.', 1.3, 44.5, 3, 5, 3, 5, 4, 5),
('Pinsir', '127', 'Stag Beetle', 'Pinsir is astoundingly strong. It can grip a foe weighing twiceits weight in its horns and easily lift it. This Pokémonsmovements turn sluggish in cold places.', 1.5, 55.0, 3, 6, 4, 3, 3, 5),
...
('Gyarados', '130', 'Atrocious', 'When Magikarp evolves into Gyarados, its brain cells undergo astructural transformation. It is said that this transformation is toblame for this Pokémons wildly violent nature.', 6.5, 235.0, 4, 6, 3, 3, 4, 4),
...
('Jolteon', '135', 'Lightning', 'Jolteons cells generate a low level of electricity. This power isamplified by the static electricity of its fur, enabling thePokémon to drop thunderbolts. The bristling fur is made ofelectrically charged needles.', 0.8, 24.5, 3, 3, 3, 5, 4, 7),
('Flareon', '136', 'Flame', 'Flareons fluffy fur has a functional purpose—it releases heatinto the air so that its body does not get excessively hot.This Pokémons body temperature can rise to a maximum of1,650 degrees Fahrenheit.', 0.9, 25.0, 3, 7, 3, 5, 5, 4),
...
('Snorlax', '143', 'Sleeping', 'Snorlaxs typical day consists of nothing more than eating andsleeping. It is such a docile Pokémon that there are childrenwho use its expansive belly as a place to play.', 2.1, 460.0, 6, 6, 3, 3, 5, 2),
...
('Mewtwo', '150', 'Genetic', 'Mewtwo is a Pokémon that was created by geneticmanipulation. However, even though the scientific power ofhumans created this Pokémons body, they failed to endowMewtwo with a compassionate heart.', 2.0, 122.0, 4, 6, 4, 8, 4, 7),
...
('Bayleef', '153', 'Leaf', 'Bayleefs neck is ringed by curled-up leaves. Inside eachtubular leaf is a small shoot of a tree. The fragrance of thisshoot makes people peppy.', 1.2, 15.8, 3, 3, 4, 3, 3, 3),
('Meganium', '154', 'Herb', 'The fragrance of Meganiums flower soothes and calmsemotions. In battle, this Pokémon gives off more of itsbecalming scent to blunt the foes fighting spirit.', 1.8, 100.5, 3, 4, 4, 4, 4, 4),
...
('Totodile', '158', 'Big Jaw', 'Despite the smallness of its body, Totodiles jaws are verypowerful. While the Pokémon may think it is just playfullynipping, its bite has enough power to cause serious injury.', 0.6, 9.5, 2, 3, 3, 2, 2, 2),
...
('Hoothoot', '163', 'Owl', 'Hoothoot has an internal organ that senses and tracks theearths rotation. Using this special organ, this Pokémon beginshooting at precisely the same time every day.', 0.7, 21.2, 3, 2, 2, 2, 2, 3),
...
('Ledyba', '165', 'Five Star', 'Ledyba secretes an aromatic fluid from where its legs join itsbody. This fluid is used for communicating with others.This Pokémon conveys its feelings to others by altering thefluids scent.', 1.0, 10.8, 2, 1, 2, 2, 3, 3),
...
('Spinarak', '167', 'String Spit', 'The web spun by Spinarak can be considered its secondnervous system. It is said that this Pokémon can determinewhat kind of prey is touching its web just by the tiny vibrationsit feels through the webs strands.', 0.5, 8.5, 2, 3, 2, 2, 2, 2),
('Ariados', '168', 'Long Leg', 'Ariadoss feet are tipped with tiny hooked claws that enable itto scuttle on ceilings and vertical walls. This Pokémonconstricts the foe with thin and strong silk webbing.', 1.1, 33.5, 3, 5, 3, 3, 3, 2),
('Crobat', '169', 'Bat', 'If this Pokémon is flying by fluttering only a pair of wings oneither the forelegs or hind legs, its proof that Crobat has beenflying a long distance. It switches the wings it uses if it is tired.', 1.8, 75.0, 3, 5, 4, 3, 3, 7),
...
('Igglybuff', '174', 'Balloon', 'Igglybuffs vocal cords are not sufficiently developed. It wouldhurt its throat if it were to sing too much. This Pokémongargles with freshwater from a clean stream.', 0.3, 1.0, 4, 2, 1, 2, 1, 1),
...
('Natu', '177', 'Tiny Bird', 'Natu cannot fly because its wings are not yet fully grown.If your eyes meet with this Pokémons eyes, it will stare backintently at you. But if you move even slightly, it will hop awayto safety.', 0.2, 2.0, 2, 3, 2, 3, 2, 4),
...
('Mareep', '179', 'Wool', 'Mareeps fluffy coat of wool rubs together and builds a staticcharge. The more static electricity is charged, the more brightlythe lightbulb at the tip of its tail glows.', 0.6, 7.8, 2, 2, 2, 3, 2, 2),
('Flaaffy', '180', 'Wool', 'Flaaffys wool quality changes so that it can generate a highamount of static electricity with a small amount of wool.The bare and slick parts of its hide are shieldedagainst electricity.', 0.8, 13.3, 3, 3, 3, 4, 3, 3),
...
('Bellossom', '182', 'Flower', 'When Bellossom gets exposed to plenty of sunlight, the leavesringing its body begin to spin around. This Pokémons dancingis renowned in the southern lands.', 0.4, 5.8, 3, 4, 4, 4, 4, 3),
('Marill', '183', 'Aqua Mouse', 'Marills oil-filled tail acts much like a life preserver. If you seejust its tail bobbing on the waters surface, its a sureindication that this Pokémon is diving beneath the water tofeed on aquatic plants.', 0.4, 8.5, 3, 1, 2, 1, 2, 2),
('Azumarill', '184', 'Aqua Rabbit', 'Azumarills long ears are indispensable sensors. By focusing itshearing, this Pokémon can identify what kinds of prey arearound, even in rough and fast-running rivers.', 0.8, 28.5, 4, 3, 4, 3, 3, 3),
...
('Politoed', '186', 'Frog', 'The curled hair on Politoeds head is proof of its status as aking. It is said that the longer and more curled the hair, themore respect this Pokémon earns from its peers.', 1.1, 33.9, 4, 4, 3, 4, 4, 4),
...
('Skiploom', '188', 'Cottonweed', 'Skiplooms flower blossoms when the temperature risesabove 64 degrees Fahrenheit. How much the flower opensdepends on the temperature. For that reason, this Pokémonis sometimes used as a thermometer.', 0.6, 1.0, 2, 2, 2, 2, 3, 4),
...
('Aipom', '190', 'Long Tail', 'Aipoms tail ends in a hand-like appendage that can be cleverlymanipulated. However, because the Pokémon uses its tail somuch, its real hands have become rather clumsy.', 0.8, 11.5, 2, 4, 3, 2, 2, 5),
...
('Umbreon', '197', 'Moonlight', 'Umbreon evolved as a result of exposure to the moons waves.It hides silently in darkness and waits for its foes to make amove. The rings on its body glow when it leaps to attack.', 1.0, 27.0, 4, 3, 5, 3, 5, 4),
...
('Wobbuffet', '202', 'Patient', 'If two or more Wobbuffet meet, they will turn competitiveand try to outdo each others endurance. However, they maytry to see which one can endure the longest without food.Trainers need to beware of this habit.', 1.3, 28.5, 7, 2, 3, 2, 2, 2),
('Girafarig', '203', 'Long Neck', 'Girafarigs rear head also has a brain, but it is small. The rearhead attacks in response to smells and sounds. Approachingthis Pokémon from behind can cause the rear head to suddenlylash out and bite.', 1.5, 41.5, 3, 4, 3, 4, 3, 5),
...
('Forretress', '205', 'Bagworm', 'Forretress conceals itself inside its hardened steel shell.The shell is opened when the Pokémon is catching prey,but it does so at such a quick pace that the shells insidecannot be seen.', 1.2, 125.8, 3, 5, 6, 3, 3, 2),
...
('Steelix', '208', 'Iron Snake', 'Steelix lives even further underground than Onix.This Pokémon is known to dig toward the earths core.There are records of this Pokémon reaching a depth of oversix-tenths of a mile underground.', 9.2, 400.0, 3, 4, 8, 3, 3, 2),
...
('Heracross', '214', 'Single Horn', 'Heracross charges in a straight line at its foe, slips beneath thefoes grasp, and then scoops up and hurls the opponent withits mighty horn. This Pokémon even has enough power totopple a massive tree.', 1.5, 54.0, 3, 6, 3, 2, 4, 5),
...
('Slugma', '218', 'Lava', 'Molten magma courses throughout Slugmas circulatorysystem. If this Pokémon is chilled, the magma cools andhardens. Its body turns brittle and chunks fall off, reducingits size.', 0.7, 35.0, 2, 2, 2, 3, 2, 1),
('Magcargo', '219', 'Lava', 'Magcargos shell is actually its skin that hardened as a resultof cooling. Its shell is very brittle and fragile—just touching itcauses it to crumble apart. This Pokémon returns to its originalsize by dipping itself in magma.', 0.8, 55.0, 2, 3, 5, 4, 3, 2),
...
('Corsola', '222', 'Coral', 'Corsolas branches glitter very beautifully in seven colors whenthey catch sunlight. If any branch breaks off, this Pokémongrows it back in just one night.', 0.6, 5.0, 2, 3, 4, 3, 4, 2),
...
('Delibird', '225', 'Delivery', 'Delibird carries its food bundled up in its tail. There once wasa famous explorer who managed to reach the peak of theworlds highest mountain, thanks to one of these Pokémonsharing its food.', 0.9, 16.0, 2, 3, 2, 3, 2, 4),
('Mantine', '226', 'Kite', 'On sunny days, schools of Mantine can be seen elegantlyleaping over the seas waves. This Pokémon is not botheredby the Remoraid that hitches rides.', 2.1, 220.0, 3, 2, 3, 4, 6, 4),
...
('Houndour', '228', 'Dark', 'Houndour hunt as a coordinated pack. They communicate witheach other using a variety of cries to corner their prey.This Pokémons remarkable teamwork is unparalleled.', 0.6, 10.8, 2, 3, 2, 4, 2, 4),
...
('Donphan', '232', 'Armor', 'Donphans favorite attack is curling its body into a ball, thencharging at its foe while rolling at high speed. Once it startsrolling, this Pokémon cant stop very easily.', 1.1, 120.0, 4, 6, 5, 3, 3, 3),
...
('Stantler', '234', 'Big Horn', 'Stantlers magnificent antlers were traded at high prices asworks of art. As a result, this Pokémon was hunted close toextinction by those who were after the priceless antlers.', 1.4, 71.2, 3, 5, 3, 4, 3, 5),
...
('Smoochum', '238', 'Kiss', 'Smoochum actively runs about, but also falls quite often.Whenever the chance arrives, it will look for its reflection tomake sure its face hasnt become dirty.', 0.4, 6.0, 2, 2, 1, 4, 3, 4),
...
('Magby', '240', 'Live Coal', 'Magbys state of health is determined by observing the fire itbreathes. If the Pokémon is spouting yellow flames from itsmouth, it is in good health. When it is fatigued, black smokewill be mixed in with the flames.', 0.7, 21.4, 2, 4, 2, 3, 2, 5),
('Miltank', '241', 'Milk Cow', 'Miltank gives over five gallons of milk on a daily basis.Its sweet milk is enjoyed by children and grown-ups alike.People who cant drink milk turn it into yogurt and eatit instead.', 1.2, 75.5, 4, 4, 5, 2, 3, 5),
...
('Lugia', '249', 'Diving', 'Lugias wings pack devastating power—a light fluttering of itswings can blow apart regular houses. As a result, thisPokémon chooses to live out of sight deep under the sea.', 5.2, 216.0, 4, 5, 6, 4, 6, 6),
('Ho-Oh', '250', 'Rainbow', 'Ho-Ohs feathers glow in seven colors depending on the angleat which they are struck by light. These feathers are said tobring happiness to the bearers. This Pokémon is said to live atthe foot of a rainbow.', 3.8, 199.0, 4, 7, 4, 5, 6, 5),
...
('Grovyle', '253', 'Wood Gecko', 'The leaves growing out of Grovyles body are convenient forcamouflaging it from enemies in the forest. This Pokémon is amaster at climbing trees in jungles.', 0.9, 21.6, 2, 3, 2, 4, 3, 5),
('Sceptile', '254', 'Forest', 'The leaves growing on Sceptiles body are very sharp edged.This Pokémon is very agile—it leaps all over the branches oftrees and jumps on its foe from above or behind.', 1.7, 52.2, 3, 4, 3, 5, 4, 6),
...
('Combusken', '256', 'Young Fowl', 'Combusken toughens up its legs and thighs by runningthrough fields and mountains. This Pokémons legs possessboth speed and power, enabling it to dole out 10 kicks inone second.', 0.9, 19.5, 3, 4, 3, 4, 3, 3),
('Blaziken', '257', 'Blaze', 'In battle, Blaziken blows out intense flames from its wrists andattacks foes courageously. The stronger the foe, the moreintensely this Pokémons wrists burn.', 1.9, 52.0, 3, 6, 3, 5, 3, 4),
('Mudkip', '258', 'Mud Fish', 'The fin on Mudkips head acts as highly sensitive radar.Using this fin to sense movements of water and air, thisPokémon can determine what is taking place around itwithout using its eyes.', 0.4, 7.6, 2, 4, 2, 2, 2, 2),
('Marshtomp', '259', 'Mud Fish', 'The surface of Marshtomps body is enveloped by a thin, stickyfilm that enables it to live on land. This Pokémon plays in mudon beaches when the ocean tide is low.', 0.7, 28.0, 3, 4, 3, 3, 3, 3),
...
('Wurmple', '265', 'Worm', 'Using the spikes on its rear end, Wurmple peels the bark offtrees and feeds on the sap that oozes out. This Pokémonsfeet are tipped with suction pads that allow it to cling to glasswithout slipping.', 0.3, 3.6, 2, 2, 2, 1, 1, 1),
...
('Beautifly', '267', 'Butterfly', 'Beautiflys favorite food is the sweet pollen of flowers. If youwant to see this Pokémon, just leave a potted flower by anopen window. Beautifly is sure to come looking for pollen.', 1.0, 28.4, 3, 4, 2, 5, 2, 4),
...
('Seedot', '273', 'Acorn', 'Seedot attaches itself to a tree branch using the top of itshead. It sucks moisture from the tree while hanging off thebranch. The more water it drinks, the glossier this Pokémonsbody becomes.', 0.5, 4.0, 2, 2, 2, 1, 1, 2),
...
('Swellow', '277', 'Swallow', 'Swellow flies high above our heads, making graceful arcsin the sky. This Pokémon dives at a steep angle as soon asit spots its prey. The hapless prey is tightly grasped bySwellows clawed feet, preventing escape.', 0.7, 19.8, 3, 4, 3, 2, 2, 7),
...
('Breloom', '286', 'Mushroom', 'Breloom closes in on its foe with light and sprightly footwork,then throws punches with its stretchy arms. This Pokémonsfighting technique puts boxers to shame.', 1.2, 39.2, 3, 7, 4, 3, 3, 4),
('Slakoth', '287', 'Slacker', 'Slakoth lolls around for over 20 hours every day. Because itmoves so little, it does not need much food. This Pokémonssole daily meal consists of just three leaves.', 0.8, 24.0, 3, 3, 3, 2, 2, 2),
('Vigoroth', '288', 'Wild Monkey', 'Vigoroth is always itching and agitated to go on a wildrampage. It simply cant tolerate sitting still for evena minute. This Pokémons stress level rises if it cantbe moving constantly.', 1.4, 46.5, 3, 4, 4, 3, 2, 5),
...
('Shedinja', '292', 'Shed', 'Shedinjas hard body doesnt move—not even a twitch. In fact,its body appears to be merely a hollow shell. It is believed thatthis Pokémon will steal the spirit of anyone peering into itshollow body from its back.', 0.8, 1.2, 1, 5, 2, 1, 1, 2),
('Whismur', '293', 'Whisper', 'Normally, Whismurs voice is very quiet—it is barely audibleeven if one is paying close attention. However, if this Pokémonsenses danger, it starts crying at an earsplitting volume.', 0.6, 16.3, 3, 3, 1, 3, 1, 2),
('Loudred', '294', 'Big Voice', 'Loudreds bellowing can completely decimate a wood-framehouse. It uses its voice to punish its foes. This Pokémonsround ears serve as loudspeakers.', 1.0, 40.5, 3, 4, 2, 3, 2, 3),
('Exploud', '295', 'Loud Noise', 'Exploud triggers earthquakes with the tremors it createsby bellowing. If this Pokémon violently inhales from theports on its body, its a sign that it is preparing to let loosea huge bellow.', 1.5, 84.0, 4, 5, 3, 4, 3, 4),
...
('Hariyama', '297', 'Arm Thrust', 'Hariyama practices its straight-arm slaps in any number oflocations. One hit of this Pokémons powerful, openhanded,straight-arm punches could snap a telephone pole in two.', 2.3, 253.8, 6, 6, 3, 2, 3, 3),
...
('Nosepass', '299', 'Compass', 'Nosepasss magnetic nose is always pointed to the north.If two of these Pokémon meet, they cannot turn their faces toeach other when they are close because their magnetic nosesrepel one another.', 1.0, 97.0, 2, 2, 6, 2, 4, 2),
...
('Mawile', '303', 'Deceiver', 'Mawiles huge jaws are actually steel horns that have beentransformed. Its docile-looking face serves to lull its foe intoletting down its guard. When the foe least expects it, Mawilechomps it with its gaping jaws.', 0.6, 11.5, 2, 4, 4, 3, 2, 3),
...
('Gulpin', '316', 'Stomach', 'Virtually all of Gulpins body is its stomach. As a result, it canswallow something its own size. This Pokémons stomachcontains a special fluid that digests anything.', 0.4, 10.3, 3, 2, 2, 2, 2, 2),
...
('Carvanha', '318', 'Savage', 'Carvanhas strongly developed jaws and its sharply pointedfangs pack the destructive power to rip out boat hulls.Many boats have been attacked and sunk by this Pokémon.', 0.8, 20.8, 2, 5, 1, 3, 1, 4),
...
('Wailmer', '320', 'Ball Whale', 'Wailmers nostrils are located above its eyes. This playfulPokémon loves to startle people by forcefully snorting outseawater it stores inside its body out of its nostrils.', 2.0, 130.0, 5, 4, 2, 3, 2, 3),
...
('Numel', '322', 'Numb', 'Numel is extremely dull witted—it doesnt notice being hit.However, it cant stand hunger for even a second.This Pokémons body is a seething cauldron of boiling magma.', 0.7, 24.0, 3, 3, 2, 3, 2, 2),
('Camerupt', '323', 'Eruption', 'Camerupt has a volcano inside its body. Magma of18,000 degrees Fahrenheit courses through its body.Occasionally, the humps on this Pokémons back erupt,spewing the superheated magma.', 1.9, 220.0, 3, 5, 3, 5, 3, 2),
...
('Trapinch', '328', 'Ant Pit', 'Trapinchs nest is a sloped, bowl-like pit dug in sand.This Pokémon patiently waits for prey to tumble down the pit.Its giant jaws have enough strength to crush even boulders.', 0.7, 15.0, 2, 5, 2, 2, 2, 1),
('Vibrava', '329', 'Vibration', 'To make prey faint, Vibrava generates ultrasonic waves byvigorously making its two wings vibrate. This Pokémonsultrasonic waves are so powerful, they can bring on headachesin people.', 1.1, 15.3, 2, 4, 2, 2, 2, 4),
...
('Zangoose', '335', 'Cat Ferret', 'Memories of battling its archrival Seviper are etched into everycell of Zangooses body. This Pokémon adroitly dodgesattacks with incredible agility.', 1.3, 40.3, 3, 6, 3, 3, 3, 5),
...
('Barboach', '339', 'Whiskers', 'Barboachs sensitive whiskers serve as a superb radar system.This Pokémon hides in mud, leaving only its two whiskersexposed while it waits for prey to come along.', 0.4, 1.9, 2, 3, 2, 2, 2, 3),
...
('Armaldo', '348', 'Plate', 'Armaldos tough armor makes all attacks bounce off. ThisPokémons two enormous claws can be freely extended orcontracted. They have the power to punch right through asteel slab.', 1.5, 68.2, 3, 6, 4, 3, 3, 3),
('Feebas', '349', 'Fish', 'Feebass fins are ragged and tattered from the start of its life.Because of its shoddy appearance, this Pokémon is largelyignored. It is capable of living in both the sea and in rivers.', 0.6, 7.4, 1, 1, 1, 1, 2, 4),
...
('Castform', '351', 'Weather', 'Castforms appearance changes with the weather.This Pokémon gained the ability to use the vast power ofnature to protect its tiny body.', 0.3, 0.8, 3, 4, 3, 3, 3, 4),
('Kecleon', '352', 'Color Swap', 'Kecleon is capable of changing its body colors at will to blendin with its surroundings. There is one exception—this Pokémoncant change the zigzag pattern on its belly.', 1.0, 22.0, 3, 5, 3, 3, 5, 2),
('Shuppet', '353', 'Puppet', 'Shuppet is attracted by feelings of jealousy and vindictiveness.If someone develops strong feelings of vengeance, thisPokémon will appear in a swarm and line up beneath the eavesof that persons home.', 0.6, 2.3, 2, 4, 2, 3, 1, 3),
...
('Dusclops', '356', 'Beckon', 'Dusclopss body is completely hollow—there is nothing at allinside. It is said that its body is like a black hole. ThisPokémon will absorb anything into its body, but nothing willever come back out.', 1.6, 30.6, 2, 4, 6, 3, 5, 2),
('Tropius', '357', 'Fruit', 'The bunches of fruit around Tropiuss neck are very popularwith children. This Pokémon loves fruit, and eats itcontinuously. Apparently, its love for fruit resulted in its ownoutgrowth of fruit.', 2.0, 100.0, 4, 4, 4, 4, 4, 3),
...
('Walrein', '365', 'Ice Break', 'Walreins two massively developed tusks can totally shatterblocks of ice weighing 10 tons with one blow. This Pokémonsthick coat of blubber insulates it from subzero temperatures.', 1.4, 150.6, 4, 4, 4, 5, 4, 4),
('Clamperl', '366', 'Bivalve', 'Clamperls sturdy shell is not only good for protection—it isalso used for clamping and catching prey. A fully grownClamperls shell will be scored with nicks and scratchesall over.', 0.4, 52.5, 2, 3, 4, 4, 2, 2),
('Huntail', '367', 'Deep Sea', 'Huntails presence went unnoticed by people for a longtime because it lives at extreme depths in the sea.This Pokémons eyes can see clearly even in the murkydark depths of the ocean.', 1.7, 27.0, 2, 5, 5, 5, 3, 3),
('Gorebyss', '368', 'South Sea', 'Gorebyss lives in the southern seas at extreme depths. Itsbody is built to withstand the enormous pressure of water atincredible depths. Because of this, this Pokémons body isunharmed by ordinary attacks.', 1.8, 22.6, 2, 4, 5, 6, 3, 3),
...
('Luvdisc', '370', 'Rendezvous', 'Luvdisc live in shallow seas in the tropics. This heart-shapedPokémon earned its name by swimming after loving couples itspotted in the oceans waves.', 0.6, 8.7, 2, 2, 3, 2, 3, 5),
...
('Shelgon', '372', 'Endurance', 'Inside Shelgons armor-like shell, cells are in the midst oftransformation to create an entirely new body. This Pokémonsshell is extremely heavy, making its movements sluggish.', 1.1, 110.5, 3, 5, 4, 3, 2, 3),
('Salamence', '373', 'Dragon', 'Salamence came about as a result of a strong, long-helddream of growing wings. It is said that this powerful desiretriggered a sudden mutation in this Pokémons cells,causing it to sprout its magnificent wings.', 1.5, 102.6, 4, 7, 4, 5, 3, 5),
('Beldum', '374', 'Iron Ball', 'Instead of blood, a powerful magnetic force coursesthroughout Beldums body. This Pokémon communicateswith others by sending controlled pulses of magnetism.', 0.6, 95.2, 2, 3, 4, 2, 3, 2),
...
('Regirock', '377', 'Rock Peak', 'Regirock was sealed away by people long ago. If thisPokémons body is damaged in battle, it is said to seekout suitable rocks on its own to repair itself.', 1.7, 230.0, 3, 5, 8, 2, 4, 3),
('Regice', '378', 'Iceberg', 'Regices body was made during an ice age. The deep-frozenbody cant be melted, even by fire. This Pokémon controlsfrigid air of -328 degrees Fahrenheit.', 1.8, 175.0, 3, 3, 4, 5, 8, 3),
...
('Kyogre', '382', 'Sea Basin', 'Through Primal Reversion and with naturesfull power, it will take back its true form. It cansummon storms that cause the sea levels to rise.', 4.5, 352.0, 4, 5, 4, 7, 6, 5),
...
('Deoxys', '386', 'DNA', 'The DNA of a space virus underwent a sudden mutation uponexposure to a laser beam and resulted in Deoxys.The crystalline organ on this Pokémons chest appears to beits brain.', 1.7, 60.8, 2, 8, 2, 7, 2, 8),
...
('Chimchar', '390', 'Chimp', 'Its fiery rear end is fueled by gas made in its belly.Even rain cant extinguish the fire.', 0.5, 6.2, 2, 3, 2, 3, 2, 3),
...
('Piplup', '393', 'Penguin', 'It doesnt like to be taken care of. Its difficult tobond with since it wont listen to its Trainer.', 0.4, 5.2, 2, 3, 2, 3, 2, 2),
...
('Budew', '406', 'Bud', 'When it feels the suns warm touch, it opens its budto release pollen. It lives alongside clear pools.', 0.2, 1.2, 2, 2, 2, 2, 3, 3),
...
('Purugly', '432', 'Tiger Cat', 'It would claim another Pokémons nest as its ownif it finds a nest sufficiently comfortable.', 1.0, 43.8, 3, 4, 3, 3, 3, 6),
...
('Bronzor', '436', 'Bronze', 'Ancient people believed that the pattern onBronzors back contained a mysterious power.', 0.5, 60.5, 2, 1, 4, 1, 4, 1),
...
('Bonsly', '438', 'Bonsai', 'It prefers arid environments. It leaks water from itseyes to adjust its bodys fluid levels.', 0.5, 15.0, 2, 4, 4, 1, 2, 1),
('Mime Jr.', '439', 'Mime', 'In an attempt to confuse its enemy, it mimics theenemys movements. Then it wastes no time inmaking itself scarce!', 0.6, 13.0, 1, 1, 2, 3, 4, 3),
...
('Chatot', '441', 'Music Note', 'It mimics the cries of other Pokémon to trick theminto thinking its one of them. This way they wontattack it.', 0.5, 1.9, 3, 3, 2, 5, 2, 5),
...
('Snover', '459', 'Frost Tree', 'During cold seasons, it migrates to the mountainslower reaches. It returns to the snow-coveredsummit in the spring.', 1.0, 50.5, 3, 3, 2, 3, 3, 2),
...
('Leafeon', '470', 'Verdant', 'When you see Leafeon asleep in a patch ofsunshine, youll know it is using photosynthesisto produce clean air.', 1.0, 25.5, 3, 6, 6, 3, 3, 5),
...
('Serperior', '497', 'Regal', 'It only gives its all against strong opponents whoare not fazed by the glare from Serperiorsnoble eyes.', 3.3, 63.0, 3, 4, 4, 4, 4, 6),
('Tepig', '498', 'Fire Pig', 'It can deftly dodge its foes attacks while shootingfireballs from its nose. It roasts berries before iteats them.', 0.5, 9.9, 3, 3, 2, 2, 2, 3),
...
('Oshawott', '501', 'Sea Otter', 'The scalchop on its stomach isnt just used forbattle—it can be used to break open hard berriesas well.', 0.5, 5.9, 2, 3, 2, 3, 2, 3),
...
('Sandile', '551', 'Desert Croc', 'It moves along below the sands surface, exceptfor its nose and eyes. A dark membrane shields itseyes from the sun.', 0.7, 15.2, 2, 4, 2, 2, 2, 4),
...
('Darumaka', '554', 'Zen Charm', 'Darumakas droppings are hot, so people used toput them in their clothes to keep themselves warm.', 0.6, 37.5, 3, 5, 2, 1, 2, 3),
...
('Sawsbuck', '586', 'Season', 'They migrate according to the seasons. People cantell the season by looking at Sawsbucks horns.', 1.9, 92.5, 3, 5, 3, 3, 3, 5),
...
('Jellicent', '593', 'Floating', 'Its body is mostly seawater. Its said theres acastle of ships Jellicent have sunk on the seafloor.', 2.2, 135.0, 4, 3, 3, 4, 4, 3),
...
('Joltik', '595', 'Attaching', 'Since it cant generate its own electricity, it sticksonto large-bodied Pokémon and absorbsstatic electricity.', 0.1, 0.6, 2, 3, 2, 3, 2, 4),
...
('Tynamo', '602', 'EleFish', 'While one alone doesnt have much power, a chainof many Tynamo can be as powerful as lightning.', 0.2, 0.3, 2, 3, 2, 2, 2, 3),
...
('Elgyem', '605', 'Cerebral', 'It uses its strong psychic power to squeeze itsopponents brain, causing unendurable headaches.', 0.5, 9.0, 2, 3, 3, 4, 2, 2),
('Beheeyem', '606', 'Cerebral', 'Apparently, it communicates by flashing its threefingers, but those patterns havent been decoded.', 1.0, 34.5, 3, 4, 3, 6, 4, 2),
...
('Chandelure', '609', 'Luring', 'Being consumed in Chandelures flame burns upthe spirit, leaving the body behind.', 1.0, 34.3, 3, 3, 4, 7, 4, 4),
...
('Pawniard', '624', 'Sharp Blade', 'Blades comprise this Pokémons entire body.If battling dulls the blades, it sharpens them onstones by the river.', 0.5, 10.2, 2, 4, 3, 2, 2, 3),
...
('Heatmor', '631', 'Anteater', 'Using their very hot, flame-covered tongues,they burn through Durants steel bodies andconsume their insides.', 1.4, 58.0, 3, 5, 3, 5, 3, 4),
...
('Quilladin', '651', 'Spiny Armor', 'It relies on its sturdy shell to deflect predatorsattacks. It counterattacks with its sharp quills.', 0.7, 29.0, 3, 4, 4, 3, 2, 3),
...
('Pangoro', '675', 'Daunting', 'Although it possesses a violent temperament,it wont put up with bullying. It uses the leaf inits mouth to sense the movements of its enemies.', 2.1, 136.0, 4, 6, 3, 3, 3, 3),
...
('Tyrunt', '696', 'Royal Heir', 'This Pokémon was restored from a fossil.If something happens that it doesnt like,it throws a tantrum and runs wild.', 0.8, 26.0, 3, 5, 3, 2, 2, 3),
...
('Goomy', '704', 'Soft Tissue', 'The weakest Dragon-type Pokémon,it lives in damp, shady places, so itsbody doesnt dry out.', 0.3, 2.8, 2, 3, 2, 3, 3, 2),
('Sliggoo', '705', 'Soft Tissue', 'It drives away opponents by excreting asticky liquid that can dissolve anything.Its eyes devolved, so it cant see anything.', 0.8, 17.5, 3, 4, 2, 4, 5, 3),
...
('Yveltal', '717', 'Destruction', 'When this legendary Pokémons wings andtail feathers spread wide and glow red,it absorbs the life force of living creatures.', 5.8, 203.0, 5, 7, 4, 6, 4, 5),
('Zygarde', '718', 'Order', 'When the Kalos regions ecosystem falls intodisarray, it appears and reveals its secret power.', 5.0, 305.0, 4, 5, 5, 4, 4, 5),
...
SELECT 
    ...
    'Ataque',
    defesa 'Defesa',
    especial_ataque 'Especial Ataque',
    especial_defesa 'Especial Defesa',
...
SELECT altura'Altura',peso'Peso', peso/(altura*altura) 'Imc' FROM pokemons ORDER BY IMC desc ;*/

###########

/*6. Selecione nome e o tamanho do nome em ordem decrescente pelo nome.
SELECT nome, CHARACTER_LENGTH(nome) 'Tamanho' FROM pokemons ORDER BY CHARACTER_LENGTH(nome) desc;*                        /

################################

/*7. Selecione nome, descrição, quando o nome contiver mais que 10 caracteres.
SELECT nome'Nome',descricao'Descrição' ,CHARACTER_LENGTH(nome)'Tamanho' FROM pokemons ORDER BY 	CHARACTER_LENGTH(nome)  >10;*/

####################

/*8. Selecione nome, categoria, e ataque do pokemon que contém o menor valor de ataque.
SELECT nome'Nome',categoria'Categoria',ataque'Ataque' FROM pokemons ORDER BY ataque desc;*/

#############

/*9. Selecione o ataque, ataque especial, nome, defesa e defesa especial ordenando pelo ataque.
SELECT ataque'Ataque', especial_ataque'Ataque especial', nome'Nome', especial_defesa'Defesa especial' FROM pokemons ORDER BY ataque ;*/

#############

/*10. Selecione a média dos ataques.
SELECT AVG(ataque)'Média ataques' FROM pokemons;*/

####################

/*11. Selecione a somatória dos ataques.
SELECT SUM(ataque)'Soma' FROM pokemons;*/
