DROP DATABASE IF EXISTS exercicio01Lista10;
CREATE DATABASE exercicio01Lista10;
USE exercicio01Lista10;
...
('Samuel Ruan Dias','802.790.194-40','55.318.691-7','1988/08/02',30),
...
SELECT  nome'Nomes',cpf'CPF',rg'RG',data_nascimento'Data de nascimento', idade'idade' FROM pessoas;
