...
SELECT cidade 'Cidades', estado 'Estados' FROM cidades;*/
...
SELECT cidade'Cidades' FROM cidades WHERE cidade LIKE '%apar%';*/
...
decrescente.
SELECT cidade 'Cidades',estado'Estados' FROM cidades WHERE cidade LIKE '%tuba' ORDER BY estado ASC;*/
